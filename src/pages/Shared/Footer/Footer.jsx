...
const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-[#ce8c8c66] text-base-content mt-5">
                <div>
                    <img src={logo} alt="" />
                    <p>Best service is our promise. <br /> Promises distribute all over the country.</p>
                </div>
                <div>
                    <span className="footer-title text-[#ab6032f1]">Services</span>
                ...
                <div>
                    <span className="footer-title text-[#ab6032f1]">Legal</span>
                    <a className="link link-hover">Terms of use</a>
                    <a className="link link-hover">Privacy policy</a>
                    <a className="link link-hover">Cookie policy</a>
                </div>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-[#ce8c8c66] text-base-content border-base-300">
